    ...
    return (
        <div className="w-full max-w-[600px] h-[500px] bg-neutral-900 rounded-md">
            ...
            <div className="h-full flex flex-col justify-center gap-3 px-4 lg:px-6">
                <h1 className="font-semibold text-lg text-neutral-100 tracking-wide">{values.tipoDaObra}</h1>

                <ul className="flex flex-col gap-[0.15rem]">
                <li className="text-neutral-500 font-medium text-sm">
                    Economia anual: <span className="ml-2 tracking-normal text-sun-500">{values.economiaAnual}</span>
                </li>
                <li className="text-neutral-500 font-medium text-sm">
                    Economia anual: <span className="ml-2 tracking-normal text-sun-500">{values.economiaMensal}</span>
                </li>
                <li className="mt-1 gap-1 flex flex-col text-neutral-500 font-medium text-sm sm:flex-row sm:gap-3">Conta de luz:
                    ...
                    <span>Antes: <span className="text-sun-500">{values.economiaGeral.antes}</span></span>
                    <span>Hoje: <span className="text-sun-500">{values.economiaGeral.depois}</span></span>
                    </div>
                </li>
                </ul>
            </div>
